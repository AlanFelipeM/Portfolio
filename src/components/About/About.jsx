...
export default function About () {
    return(
        ...
        <h2>Olá,</h2>
        <p>Meu nome é Alan Felipe e sou um jovem apaixonado por tecnologia, estudante de Engenharia da Computação e aluno da OnebitCode. <br/> Atualmente sou desenvolvedor Front-End e UI/UX Designer mas estou em constante estudo e aprendizado para me tornar um desenvolvedor FullStack. </p>
